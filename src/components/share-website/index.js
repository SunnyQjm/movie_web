        ...
        return (
            <ShareWebsiteBody>
                <Form layout={'horizontal'} onSubmit={(e) => {
                    ...
                    >
                        {
                            ...
                            })(<BaseInput addonBefore={selectBefore}
                                          addonAfter={selectAfter}
                                          placeholder="例如: qjm253.cn"/>)
                        }
                    </BaseFormItem>
                    <BaseFormItem
                        label="网站类别"
                    ...
                    <BaseFormItem>
                        <Button type={'primary'} htmlType="submit" size={'large'} loading={false} disabled={hasErrors(getFieldsError())}>
                            分享
                        </Button>
                    </BaseFormItem>
                </Form>
...
export default Form.create({})(ShareWebsiteComponent);